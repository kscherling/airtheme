...
var composedMiddleware = compose.apply(undefined, [applyMiddleware.apply(undefined, middleware)].concat(enhancers));
...
var airthemeReducer = combineReducers({ theme: theme });
...
function isValidElementType(type$$1) {
  ...
  type$$1 === REACT_FRAGMENT_TYPE || type$$1 === REACT_ASYNC_MODE_TYPE || type$$1 === REACT_PROFILER_TYPE || type$$1 === REACT_STRICT_MODE_TYPE || type$$1 === REACT_TIMEOUT_TYPE || typeof type$$1 === 'object' && type$$1 !== null && (type$$1.$$typeof === REACT_PROVIDER_TYPE || type$$1.$$typeof === REACT_CONTEXT_TYPE || type$$1.$$typeof === REACT_FORWARD_REF_TYPE);
}

function getComponentName(fiber) {
  var type$$1 = fiber.type;

  if (typeof type$$1 === 'function') {
    return type$$1.displayName || type$$1.name;
  }
...

{
  ...
  getDisplayName = function (element) {
    ...
    if (type$$1 === REACT_FRAGMENT_TYPE) {
      ...
      return type$$1.displayName || type$$1.name || 'Unknown';
    }
  };
...
function validatePropTypes(element) {
  ...
  if (typeof type$$1.getDefaultProps === 'function') {
    !type$$1.getDefaultProps.isReactClassApproved ? warning(false, 'getDefaultProps is only used on classic React.createClass ' + 'definitions. Use a static property named `defaultProps` instead.') : void 0;
  }
}
...
var defaultStore = makeStore({ theme: type.theme.base() });

var MakeProvider = function MakeProvider(_ref) {
  var _ref$store = _ref.store,
      store = _ref$store === undefined ? defaultStore : _ref$store,
