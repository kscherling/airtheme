...
if (process.env.NODE_ENV !== "production") {
  (function () {
    ...
    var ReactElement = function ReactElement(type$$1, key, ref, self, source, owner, props) {
      var element = {
    ...
    function isValidElementType(type$$1) {
      return typeof type$$1 === 'string' || typeof type$$1 === 'function' || // Note: its typeof might be other than 'symbol' or 'number' if it's a polyfill.
      type$$1 === REACT_FRAGMENT_TYPE || type$$1 === REACT_ASYNC_MODE_TYPE || type$$1 === REACT_PROFILER_TYPE || type$$1 === REACT_STRICT_MODE_TYPE || type$$1 === REACT_TIMEOUT_TYPE || _typeof(type$$1) === 'object' && type$$1 !== null && (type$$1.$$typeof === REACT_PROVIDER_TYPE || type$$1.$$typeof === REACT_CONTEXT_TYPE || type$$1.$$typeof === REACT_FORWARD_REF_TYPE);
    }
    ...
    function getComponentName(fiber) {
      ...
      if (_typeof(type$$1) === 'object' && type$$1 !== null) {
...

    {
      ...
      getDisplayName = function getDisplayName(element) {
        ...
        } else if (_typeof(type$$1) === 'object' && type$$1 !== null && type$$1.$$typeof === REACT_FORWARD_REF_TYPE) {
          var functionName = type$$1.render.displayName || type$$1.render.name || '';
          return functionName !== '' ? 'ForwardRef(' + functionName + ')' : 'ForwardRef';
        } else {
    ...
    function createElementWithValidation(type$$1, props, children) {
      var validType = isValidElementType(type$$1); // We warn in this case but don't throw. We expect the element creation to
      // succeed and there will likely be errors in render.

      if (!validType) {
        var info = '';

        if (type$$1 === undefined || _typeof(type$$1) === 'object' && type$$1 !== null && Object.keys(type$$1).length === 0) {
    ...
    function createFactoryWithValidation(type$$1) {
      ...
      validatedFactory.type = type$$1; // Legacy hook: remove it
