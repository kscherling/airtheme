...
function getComponentName(type$$1) {
  if (type$$1 == null) {
    // Host root, text node or just invalid type.
    return null;
  }
  {
    if (typeof type$$1.tag === 'number') {
      warningWithoutStack$1(false, 'Received an unexpected object in getComponentName(). ' + 'This is likely a bug in React. Please file an issue.');
    }
  }
  if (typeof type$$1 === 'function') {
    return type$$1.displayName || type$$1.name || null;
  }
  ...
  if (typeof type$$1 === 'object') {
    switch (type$$1.$$typeof) {
      case REACT_CONTEXT_TYPE:
        return 'Context.Consumer';
      case REACT_PROVIDER_TYPE:
        return 'Context.Provider';
      case REACT_FORWARD_REF_TYPE:
        var renderFn = type$$1.render;
        var functionName = renderFn.displayName || renderFn.name || '';
        return type$$1.displayName || (functionName !== '' ? 'ForwardRef(' + functionName + ')' : 'ForwardRef');
    }
    if (typeof type$$1.then === 'function') {
      var thenable = type$$1;
 ...
 * @internal
 */
var ReactElement = function (type$$1, key, ref, self, source, owner, props) {
  var element = {
 ...
 */
function createElement(type$$1, config, children) {
  var propName = void 0;
  ...
  if (type$$1 && type$$1.defaultProps) {
    var defaultProps = type$$1.defaultProps;
  ...
  {
    if (key || ref) {
      var displayName = typeof type$$1 === 'function' ? type$$1.displayName || type$$1.name || 'Unknown' : type$$1;
      if (key) {
  ...
  return ReactElement(type$$1, key, ref, self, source, ReactCurrentOwner.current, props);
}
...
function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
  ...
  if (type$$1 === 'undefined' || type$$1 === 'boolean') {
...
function isValidElementType(type$$1) {
  return typeof type$$1 === 'string' || typeof type$$1 === 'function' ||
  // Note: its typeof might be other than 'symbol' or 'number' if it's a polyfill.
  type$$1 === REACT_FRAGMENT_TYPE || type$$1 === REACT_ASYNC_MODE_TYPE || type$$1 === REACT_PROFILER_TYPE || type$$1 === REACT_STRICT_MODE_TYPE || type$$1 === REACT_PLACEHOLDER_TYPE || typeof type$$1 === 'object' && type$$1 !== null && (typeof type$$1.then === 'function' || type$$1.$$typeof === REACT_PROVIDER_TYPE || type$$1.$$typeof === REACT_CONTEXT_TYPE || type$$1.$$typeof === REACT_FORWARD_REF_TYPE);
}
...
function validatePropTypes(element) {
  var type$$1 = element.type;
  var name = void 0,
      propTypes = void 0;
  if (typeof type$$1 === 'function') {
    // Class or functional component
    name = type$$1.displayName || type$$1.name;
    propTypes = type$$1.propTypes;
  } else if (typeof type$$1 === 'object' && type$$1 !== null && type$$1.$$typeof === REACT_FORWARD_REF_TYPE) {
    // ForwardRef
    var functionName = type$$1.render.displayName || type$$1.render.name || '';
    name = type$$1.displayName || (functionName !== '' ? 'ForwardRef(' + functionName + ')' : 'ForwardRef');
    propTypes = type$$1.propTypes;
  } else {
    return;
  }
  if (propTypes) {
    ...
    setCurrentlyValidatingElement(null);
  } else if (type$$1.PropTypes !== undefined && !propTypesMisspellWarningShown) {
    propTypesMisspellWarningShown = true;
    warningWithoutStack$1(false, 'Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?', name || 'Unknown');
  }
  if (typeof type$$1.getDefaultProps === 'function') {
    !type$$1.getDefaultProps.isReactClassApproved ? warningWithoutStack$1(false, 'getDefaultProps is only used on classic React.createClass ' + 'definitions. Use a static property named `defaultProps` instead.') : void 0;
  }
}
...
function createElementWithValidation(type$$1, props, children) {
  var validType = isValidElementType(type$$1);

  // We warn in this case but don't throw. We expect the element creation to
  // succeed and there will likely be errors in render.
  if (!validType) {
    var info = '';
    if (type$$1 === undefined || typeof type$$1 === 'object' && type$$1 !== null && Object.keys(type$$1).length === 0) {
    ...
    if (type$$1 === null) {
      ...
      typeString = 'array';
    } else if (type$$1 !== undefined && type$$1.$$typeof === REACT_ELEMENT_TYPE) {
      typeString = '<' + (getComponentName(type$$1.type) || 'Unknown') + ' />';
      info = ' Did you accidentally export a JSX literal instead of a component?';
    } else {
      typeString = typeof type$$1;
    }
  ...
  if (validType) {
    for (var i = 2; i < arguments.length; i++) {
      validateChildKeys(arguments[i], type$$1);
    }
  }

  if (type$$1 === REACT_FRAGMENT_TYPE) {
...
function createFactoryWithValidation(type$$1) {
  var validatedFactory = createElementWithValidation.bind(null, type$$1);
  validatedFactory.type = type$$1;
